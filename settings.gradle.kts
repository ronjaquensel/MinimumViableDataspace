...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            from("org.eclipse.edc:edc-versions:0.0.1-20221214-SNAPSHOT")
        ...
        create("identityHub") {
            version("identityHub", "0.0.1-20221214-SNAPSHOT")
        ...
        create("registrationService") {
            version("registrationService", "0.0.1-20221214-SNAPSHOT")
        ...
        create("fcc") {
            version("catalog", "0.0.1-20221214-SNAPSHOT")
        ...
        create("edc") {
            version("edc", "0.0.1-20221214-SNAPSHOT")
